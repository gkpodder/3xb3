...
# tests
Test_cases = [create_near_sorted_list(400, 100, n)
              for n in range(100, 2000, 100)]
x_axis = [n for n in range(100, 2000, 100)]
print(Test_cases)
...
ax.plot(x_axis, sorting_times[0], label="quick", color="blue")
ax.plot(x_axis, sorting_times[1], label="merge", color="green")
ax.plot(x_axis, sorting_times[2], label="heap", color="red")
